 ...
 */
class dolidacticielbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "dolidacticiel@dolidacticiel";
    public $boxlabel;
    public $depends = array("dolidacticiel");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/dolidacticiel/class/dolidacticiel.class.php";
